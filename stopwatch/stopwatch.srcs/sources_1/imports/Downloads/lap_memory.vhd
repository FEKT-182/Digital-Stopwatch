...
begin
    ...
    -- Asynchronni cteni
    -- read_addr je one-hot: SW0='00001'->slot0, SW1='00010'->slot1, ...
    -- Pokud zadny spinac neni aktivni, nebo vice nez jeden, zobraz slot 0.
    process(read_addr, mem)
        variable idx : integer range 0 to 4;
    begin
        idx := 0;  -- default: slot 0
        for i in 0 to 4 loop
            if read_addr(i) = '1' then
                idx := i;
            end if;
        end loop;
